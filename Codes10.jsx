      ...
      <div className='container-fluid pb-5 text-light'>
        ...
        <div class='row'>
          ...
          <div class='col-md-3'>
            ...
            <li class='list-group-item bg-dark border-dark text-light'>
              10-99: Officer in Distress <br />
            </li>
            <li class='list-group-item bg-dark border-dark text-light'>
              Code 5: Felony Stop <br />
            </li>
            <li class='list-group-item bg-dark border-dark text-light'>
              Signal 11: Radar (Speed Trap)
            </li>
          </div>
          <div class='col-md-3'>
            <li class='list-group-item bg-dark border-dark text-light'>
            ...
            <li class='list-group-item bg-dark border-dark text-light'>
              10-52: Requesting EMS <br />
            </li>
            <li class='list-group-item bg-dark border-dark text-light'>
              10-53: Requesting Fire Dept. <br />
            </li>
            <li class='list-group-item bg-dark border-dark text-light'>
